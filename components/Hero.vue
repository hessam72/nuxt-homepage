...
<template>
  <div
    ...
    :class="[
      theme_value ? 'dark-background' : 'light-background',
    ]"
  >
    ...
    <p class="hero-p">
      Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ten ectetur adipisicing elit. Tenetur
      molestias, doloribus ab quis, ipsa praesentium consequatur veli tipsa praesentium consequatur velit
      asperiores harum laudantium?
    </p>
